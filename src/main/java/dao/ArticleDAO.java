...
public class ArticleDAO implements ArticleDAOInterface {
	...
	private static final String SELECT_ARTICLES_BY_ID = "SELECT * FROM Article a JOIN Player p ON p.idPlayer = a.idPlayer WHERE a.idPlayer=? ORDER BY datePost DESC;";
	private static final String INSERT_ARTICLE = "INSERT INTO Article(idPlayer,datePost,title,content) VALUES (?,NOW(),?,?);";
